...
## v0.9.9-rc.2 Release Candidate

The current candidate is `v0.9.9-rc.2`, with workspace and publishable crate
...
Candidate notes are in `docs/release-notes-v0.9.9-rc.2.md`; the exact gate,
...
For `v0.9.9-rc.2`, the generated software inventory has no partial or unmapped
...
1. Reconcile the matrices, release metadata, version files, and exact parity
   inventory for `v0.9.9-rc.2`.
2. Run the focused and full local release gates, then commit the reviewed tree.
3. Tag and push `v0.9.9-rc.2`; inspect the release, pinned-Python, security, and
