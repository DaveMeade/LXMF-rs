...
- Small opportunistic peer sends remain on the single-packet path and report
  `sent: opportunistic` with the sent packet hash, `opportunistic-packet`
