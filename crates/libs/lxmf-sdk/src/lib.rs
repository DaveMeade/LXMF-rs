...
pub use domain::{
    ...
    IdentityBundle, IdentityImportRequest, IdentityRef, IdentityResolveRequest,
    MarkerCreateRequest, MarkerDeleteRequest, MarkerId, MarkerListRequest, MarkerListResult,
    MarkerRecord, MarkerUpdatePositionRequest, PaperDecodeResult, PaperMessageEnvelope,
    ...
    PropagationRemoteRequest, PropagationRemoteStats,
