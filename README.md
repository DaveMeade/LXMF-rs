...
`0.9.9` workspace packages are being exercised by the `v0.9.9-rc.2` prerelease,
...
- Release notes: `docs/release-notes-v0.9.9-rc.2.md`
...
`v0.9.9-rc.2`, with workspace/package version `0.9.9`.

Use `docs/release-notes-v0.9.9-rc.2.md` for the candidate summary and
...
cargo xtask package-daemon-bundle --version 0.9.9-rc.2
...
cargo xtask public-benchmark --release v0.9.9-rc.2
```
...
make package-daemon-bundle VERSION=0.9.9-rc.2
