...
`0.9.9` workspace packages are being exercised by the `v0.9.9-rc.4` prerelease,
...
- Release notes: `docs/release-notes-v0.9.9-rc.4.md`
...
`v0.9.9-rc.4`, with workspace/package version `0.9.9`.

Use `docs/release-notes-v0.9.9-rc.4.md` for the candidate summary and
...
cargo xtask package-daemon-bundle --version 0.9.9-rc.4
...
make package-daemon-bundle VERSION=0.9.9-rc.4
